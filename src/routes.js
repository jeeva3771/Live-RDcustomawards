...
const EnquirysList = React.lazy(() => import('./views/pages/enquiry/List'))
...
const routes = [
  ...
  { path: '/enquiries', name: 'Enquirys List', element: EnquirysList },

  { path: '/enquiryform', name: 'Enquiry Form', element: EnquiryForm },

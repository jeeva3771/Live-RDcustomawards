            ...
            <div className="modal-two-column-row">
              <div className="modal-section">
                ...
                <div className="modal-detail-item">
                  ...
                  <span className="modal-value">{product.billingAddress?.street}</span>
                </div>
                <div className="modal-detail-item">
                  <span className="modal-label">City:</span>
                  <span className="modal-value">{product.billingAddress?.city}</span>
                </div>
                <div className="modal-detail-item">
                  <span className="modal-label">State:</span>
                  <span className="modal-value">{product.billingAddress?.state}</span>
                </div>
                <div className="modal-detail-item">
                  <span className="modal-label">Postal Code:</span>
                  <span className="modal-value">{product.billingAddress?.postalCode}</span>
                </div>
              </div>

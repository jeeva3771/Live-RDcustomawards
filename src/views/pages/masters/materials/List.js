...
const MaterialsList = () => {
  ...
  const filteredProcesses = useMemo(() => {
    return processes.filter(
      (process) =>
        process.materialName.toLowerCase().includes(searchTerm.toLowerCase()) ||
        process.code.toLowerCase().includes(searchTerm.toLowerCase()) ||
        process.status.toLowerCase().includes(searchTerm.toLowerCase()) ||
        process.price.toLowerCase().includes(searchTerm.toLowerCase()) ||
        process.unit.toLowerCase().includes(searchTerm.toLowerCase()),
    )
  ...
  return (
    <CCol xs={12}>
      <CCard className="mb-4">
        <CCardHeader>
          <strong className="clr-blue fs-5">Materials List</strong>
        </CCardHeader>
        <CCardBody>
              ...
              {paginatedProcesses.length > 0 ? (
                paginatedProcesses.map((process, index) => (
                  <CTableRow key={process.id}>
                    ...
                    <CTableDataCell>{process.unit}</CTableDataCell>
      ...
      >
        <CModalHeader closeButton>
          <strong className="clr-blue fs-5">
            {modalType === 'info' && 'Material Details'}
            {modalType === 'delete' && 'Delete Material'}
          </strong>
        </CModalHeader>
          ...
          {selectedProcess && modalType === 'info' && (
            <div>
              ...
              <CRow className="mb-2">
                ...
                <CCol sm={7}>{selectedProcess.price}</CCol>
              </CRow>
              ...
              <CRow className="mb-2">
                ...
                <CCol sm={7}>{selectedProcess.cost}</CCol>
              </CRow>
              ...
              <CRow className="mb-2">
                ...
                <CCol sm={7}>{selectedProcess.stock}</CCol>
              </CRow>
              ...
              <CRow className="mb-2">
                ...
                <CCol sm={7}>{selectedProcess.unit}</CCol>
              </CRow>
          ...
          {selectedProcess && modalType === 'delete' && (
            <div className="text-center">
              ...
              <p className="mb-4">
                ...
                <strong className="clr-black">"{selectedProcess.materialName}"</strong>?
                <br />
